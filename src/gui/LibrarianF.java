 ...
 * @author Heller
 */
public class LibrarianF extends javax.swing.JFrame {

    Color c = new Color(150, 150, 255);
    /**
     * Creates new form LibrarianF
     */
    //constructor
    public LibrarianF() {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            this.setVisible(false);
            InsertAudiovisual inter = new InsertAudiovisual();
            inter.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            this.setVisible(false);
            UpdateCopiesBook update = new UpdateCopiesBook();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            this.setVisible(false);
            UpdateQuantityAudiovisual update=new UpdateQuantityAudiovisual();
            update.setVisible(true);
        } catch (IOException ex) {
            Logger.getLogger(LibrarianF.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
